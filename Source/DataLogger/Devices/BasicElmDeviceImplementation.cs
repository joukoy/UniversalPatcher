...
namespace UniversalPatcher
{
    ...
    /// </summary>
    public class BasicElmDeviceImplementation : ElmDeviceImplementation
    {
        /// <summary>
        /// Device type for use in the Device Picker dialog box, and for internal comparisons.
        /// </summary>
        public const string DeviceType = "Elm device";
        
        /// <summary>
        /// Constructor.
        /// </summary>
        public BasicElmDeviceImplementation(
        ...
        /// </summary>
        public override bool Initialize(bool CheckCompatibility)
        {
            ...
            try
            {
				...
				Logger("It can be used only for Analyzer");
        ...
        public override void Receive()
        {
            try
            {
                string response = this.ReadELMLine();
        ...
        private void ReceiveViaMonitorMode()
        {
            try
            {
                string monitorResponse = this.SendRequest("AT MA");
