...
namespace UniversalPatcher
{
    ...
    public static class DeviceId
    {
        ...
        /// </summary>
        public static string ReceiverCategory(byte[] message)
        {
            byte[] b = message;
        ...
        /// </summary>
        public static string SenderCategory(byte[] message)
        {
            byte[] b = message;
            if (b.Length < 3) return "invalid message";
    ...
    {
        public const byte SendOnce = 0x01;
        public const byte SendSlowly = 0x12;
        public const byte SendMedium1 = 0x13;
        public const byte SendMedium2 = 0x14;
        public const byte SendFast = 0x24;
    }
