...
namespace PcmHacking
{
    ...
    public partial class Protocol
    {
        ...
        /// </summary>
        public Message RequestDpids(DpidCollection dpids,bool usepassivemode)
        {
//#if FAST_LOGGING
            if (usepassivemode)
            {
                ...
                byte[] header = new byte[] { Priority.Physical0High, DeviceId.Pcm, DeviceId.Tool, Mode.SendDynamicData, responseType };
