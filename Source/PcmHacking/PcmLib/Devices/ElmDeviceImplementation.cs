...
namespace PcmHacking
{
    ...
    public class ElmDeviceImplementation
    {
        ...
        public virtual bool Initialize()
        {
            ...
            this.Logger.AddDebugMessage(response = this.SendRequest("AT Z"));  // reset
            ...
            this.Logger.AddDebugMessage(this.SendRequest("AT E0")); // disable echo
            this.Logger.AddDebugMessage(this.SendRequest("AT S0")); // no spaces on responses
        ...
        /// </summary>
        protected Response<Message> ReadELMPacket()
        {
