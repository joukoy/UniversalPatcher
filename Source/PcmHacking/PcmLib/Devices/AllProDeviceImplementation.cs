    ...
    public class AllProDeviceImplementation : ElmDeviceImplementation
    {
        ...
        public override bool Initialize()
        {
            ...
            try
            {
                ...
                this.Logger.AddUserMessage("All Pro self test result: " + this.SendRequest("AT #3"));  // self test
                this.Logger.AddUserMessage("All Pro firmware: " + this.SendRequest("AT @1"));          // firmware check
            }
