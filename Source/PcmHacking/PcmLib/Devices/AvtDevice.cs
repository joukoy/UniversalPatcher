...
namespace PcmHacking
{
    ...
    public class AvtDevice : SerialDevice
    {
        ...
        /// </summary>
        public Response<Message> FindResponse(Message expected)
        {
            ...
            {
                Response<Message> response = this.ReadAVTPacket();
        ...
        /// </summary>
        private Response<Message> ReadAVTPacket()
        {
        ...
        /// </summary>
        private Response<Message> SendAVTPacket(Message message)
        {
        ...
        private Response<Boolean> AVTSetup()
        {
            ...
            Response<Message> m = this.FindResponse(AVT_DISABLE_TX_ACK_OK);
            if (m.Status == ResponseStatus.Success)
            {
            ...
            m = this.FindResponse(AVT_FILTER_DEST_OK);
            if (m.Status == ResponseStatus.Success)
            {
        ...
        protected override void Receive()
        {
            ...
            Response<Message> response = ReadAVTPacket();
            if (response.Status == ResponseStatus.Success)
            {
