...
namespace PcmHacking
{
    ...
    public partial class Vehicle : IDisposable
    {
        ...
        /// </summary>
        public Response<string> QuerySerial()
        {
            this.device.SetTimeout(TimeoutScenario.ReadProperty);

            this.device.ClearMessageQueue();

            if (!this.device.SendMessage(this.protocol.CreateSerialRequest1()))
            {
                return Response.Create(ResponseStatus.Timeout, "Unknown. Request for block 1 failed.");
            }
            ...
            if (!this.device.SendMessage(this.protocol.CreateSerialRequest2()))
            {
                return Response.Create(ResponseStatus.Timeout, "Unknown. Request for block 2 failed.");
            }
            ...
            if (!this.device.SendMessage(this.protocol.CreateSerialRequest3()))
            {
                return Response.Create(ResponseStatus.Timeout, "Unknown. Request for block 3 failed.");
            }
        ...
        /// </summary>
        public Response<string> QueryBCC()
        {
            this.device.SetTimeout(TimeoutScenario.ReadProperty);
        ...
        /// </summary>
        public Response<string> QueryMEC()
        {
            this.device.SetTimeout(TimeoutScenario.ReadProperty);
        ...
        /// </remarks>
        public Response<bool> UpdateVin(string vin)
        {
            this.device.ClearMessageQueue();
            ...
            Response<bool> block1 = WriteBlock(BlockId.Vin1, vin1);
            ...
            Response<bool> block2 = WriteBlock(BlockId.Vin2, vin2);
            ...
            Response<bool> block3 = WriteBlock(BlockId.Vin3, vin3);
        ...
        /// </summary>
        /// <returns></returns>
        public Response<UInt32> QueryOperatingSystemId(CancellationToken cancellationToken)
        {
            this.device.SetTimeout(TimeoutScenario.ReadProperty);
            return this.QueryUnsignedValue(this.protocol.CreateOperatingSystemIdReadRequest, cancellationToken);
        }
        ...
        /// </remarks>
        public Response<UInt32> QueryHardwareId()
        {
            return this.QueryUnsignedValue(this.protocol.CreateHardwareIdReadRequest, CancellationToken.None);
        }

        /// <summary>
        /// Query the PCM's calibration ID.
        /// </summary>
        public Response<UInt32> QueryCalibrationId()
        {
            this.device.SetTimeout(TimeoutScenario.ReadProperty);
        ...
        /// </summary>
        private Response<UInt32> QueryUnsignedValue(Func<Message> generator, CancellationToken cancellationToken)
        {
            this.device.SetTimeout(TimeoutScenario.ReadProperty);
