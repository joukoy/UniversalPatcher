            ...
            foreach (LogColumn column in group.LogColumns)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        try
                        {
                            string math = column.Conversion.Expression.ToLower().Replace("x", value.ToString());
                            convertedValue = Utility.parser.Parse(math);
                        ...
                        formattedValue = convertedValue.ToString(format).Replace(",",".");
                    }
