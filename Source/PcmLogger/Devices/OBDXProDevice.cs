    ...
    public class OBDXProDevice : SerialDevice
    {
        ...
        private Response<OBDMessage> ReadDVIPacket(int timeout = 0)
        {
            ...
            else if (receive[0] == 0x7F)
            {
                ...
                OBDMessage result = new OBDMessage(receive);
            ...
            else
            {
                ...
                return Response.Create(ResponseStatus.Success, new OBDMessage(receive));
            }
        }
        ...
        /// </summary>
        private Response<OBDMessage> SendDVIPacket(OBDMessage message)
        {
